...
import com.rizky.submissionthreemoviecatalogue.db.DatabaseContract.MovieFavoriteColumns.Companion.TABLE_NAME_MOVIE
import com.rizky.submissionthreemoviecatalogue.db.DatabaseContract.TvShowFavoriteColumns.Companion.TABLE_NAME_TVSHOW
...
internal class DatabaseHelper(context: Context) :
    ...
    companion object {
        ...
        private const val SQL_CREATE_TABLE_MOVIE = "CREATE TABLE $TABLE_NAME_MOVIE" +
                "(${DatabaseContract.MovieFavoriteColumns._ID} INTEGER UNIQUE," +
        ...
        private const val SQL_CREATE_TABLE_TVSHOW = "CREATE TABLE $TABLE_NAME_TVSHOW" +
                "(${DatabaseContract.TvShowFavoriteColumns._ID} INTEGER UNIQUE," +
